...
class ConfigRepository(private val context: Context) {
    ...
    companion object {
        ...
        private val KEY_SRT_HOST = stringPreferencesKey("srt_host")
        private val KEY_SRT_BASE_PORT = intPreferencesKey("srt_base_port")
        private val KEY_OBS_API_HOST = stringPreferencesKey("obs_api_host")
    ...
    suspend fun saveConfig(config: AppConfig) {
        context.dataStore.edit { prefs ->
            ...
            prefs[KEY_SRT_HOST] = config.srtHost
            prefs[KEY_SRT_BASE_PORT] = config.srtBasePort
            prefs[KEY_OBS_API_HOST] = config.obsApiHost
